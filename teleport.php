    ...
    <body id="second-page">
        <form method="post" id="teleport-form">
            <div class="content">
                ...
                <a id="new_btn" class="submit panel" href="#"><button type="submit" hidefocus="true" id="submitIt">Submit</button></a>
                <div id="logo-wrapper">
            ...
            $("#submitIt").click(function() {
                ...
                geocoder.geocode( {"address": place}, function(results, status) {
                    if (status == google.maps.GeocoderStatus.OK) {
                        ...
                        $.blockUI({ message: '<p>Oops. Please enter a place and feeling before your proceed</p>' });
                    }
                });
                return false;
            });
