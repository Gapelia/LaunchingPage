	...
	<body id="fourth-page">
		...
		<div class="content">
			...
			<form action="/map/" method="POST" id="form-map">
				<button id="login-google" class="login-google login">Sign in with Google</button><br/>
				<button id="login-facebook" class="login-facebook login">Sign in with Facebook</button>
			</form>
