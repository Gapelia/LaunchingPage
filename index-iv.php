	...
	<body id="fourth-page">
		...
		<div class="container">
			...
			<div class="content">
				...
				<form>
					<div class="left">
						<input id="emailb" placeholder="Email" hidefocus="true" type="text"/>
						<input id="passwordb" placeholder="Password" hidefocus="true" type="password" required/>

						<a href=""><button id="mailb" class="submit login" type="submit" hidefocus="true">Submit</button></a>
					</div>

					<hr/>

					<div class="right">
						<a class="login"><button id="login-facebook-02" class="login-facebook login">Login with Facebook</button></a><br/>
						<a class="login"><button id="login-twitter-02" class="login-twitter login">Login with Twitter</button></a>
					</div>
				</form>
